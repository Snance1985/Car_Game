...
race_btn.addEventListener('click', function(){
    ...
    const player1_distance = Math.min(Math.floor(Math.random() * 81), 40); // Max movement of 80
    const computer_distance = Math.min(Math.floor(Math.random() * 81), 40); // Max movement of 80
